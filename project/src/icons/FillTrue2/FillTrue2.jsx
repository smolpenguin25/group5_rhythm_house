...
export const FillTrue2 = ({ className }) => {
  return (
    <svg
      className={`fill-true-2 ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
    ...
    >
      <g className="g" clipPath="url(#clip0_884_18713)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_884_18713">
