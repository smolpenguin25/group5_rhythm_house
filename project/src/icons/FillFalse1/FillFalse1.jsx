...
export const FillFalse1 = ({ color = "#222222", className }) => {
  return (
    <svg
      className={`fill-false-1 ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
    ...
    >
      <g className="g" clipPath="url(#clip0_893_307)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_893_307">
