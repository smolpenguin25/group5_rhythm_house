...
export const FillFalse2 = ({ className }) => {
  return (
    <svg
      className={`fill-false-2 ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
    ...
    >
      <g className="g" clipPath="url(#clip0_190_2259)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_190_2259">
