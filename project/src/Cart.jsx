            ...
            <div className='cart-item'>
                ...
                <div className='font-20'>
                    ...
                    <ButtonGroup aria-label="Basic example" className='change-button'>
                        <Button variant="primary" className='inside-button'
                            onClick={() => {
                                item.amount--;
                                if (item.amount <= 0) {
                        ...
                        <Button variant="primary" className='inside-button1'
                            onClick={() => { item.amount++; setCartList(oldCart => [...oldCart]) }}>
                            +
                        </Button>
                    </ButtonGroup>
                </div>
        ...
        <div className="cart-container">
            ...
            <div className='pay-bar-container'>
                <div className='pay-bar'>
                    ...
                    <div><Button className='pay-button'>To Payment</Button></div>
                </div>
            </div>
        </div>
    );
